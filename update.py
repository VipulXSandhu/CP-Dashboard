...
new_modal = """    <div class="modal settings-modal-wide" id="settings-modal" style="width: 850px; max-width: 95%; height: 500px; display: flex; flex-direction: column; padding: 0;">
...
pattern = re.compile(r'<div class="modal"\s+id="settings-modal".*?</form>\s*</div>', re.DOTALL)
new_content = pattern.sub(new_modal, content)

with open('index.html', 'w', encoding='utf-8') as f:
    f.write(new_content)

print("Settings HTML replaced successfully.")
